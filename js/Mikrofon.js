...
const API_CATEGORY = "mikrofon";
const DETAIL_CAT = "mikrofon";
const CATEGORY_LABEL = "Mikrofon";
const CATEGORY_PAGE_SIZE = 6;

const NAME_POOL = ["Shure SM58","AKG P120","Audio-Technica AT2020","Rode NT1-A","Blue Yeti USB","HyperX QuadCast","Sennheiser E835","Behringer C-1","Samson C01U Pro","Rode PodMic"];
