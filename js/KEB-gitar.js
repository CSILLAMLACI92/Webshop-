const BASE_PRICE = 145000;
const API_CATEGORY = "gitar";
const DETAIL_CAT = "gitar";
const CATEGORY_LABEL = "Gitar";
const CATEGORY_PAGE_SIZE = 6;

const NAME_POOL = ["Yamaha Pacifica 112V","Fender Stratocaster","Ibanez RG421","Epiphone Les Paul","PRS SE Custom 24","Jackson Dinky JS22","Squier Affinity Strat","Cort X100","Harley Benton ST-20","Schecter C-6 Deluxe"];
...
function normalizeText(text) {
  ...
  out = out
    .replace(/\u00C3\u00A1|\u00C4\u0083\u02C7|\u00C4\u0082\u02C7/g, "\u00E1")
    .replace(/\u00C3\u00A9|\u00C4\u0083\u00A9|\u00C4\u0082\u00A9/g, "\u00E9")
    .replace(/\u00C3\u00AD|\u00C4\u0083\u00AD|\u00C4\u0082\u00AD/g, "\u00ED")
    .replace(/\u00C3\u00B3|\u00C4\u0083\u00B3|\u00C4\u0082\u00B3/g, "\u00F3")
    .replace(/\u00C3\u00B6|\u00C4\u0083\u00B6|\u00C4\u0082\u00B6/g, "\u00F6")
    .replace(/\u00C3\u00BA|\u00C4\u0083\u00BA|\u00C4\u0082\u00BA/g, "\u00FA")
    .replace(/\u00C3\u00BC|\u00C4\u0083\u00BC|\u00C4\u0082\u00BC/g, "\u00FC")
    .replace(/\u00C3\u0081|\u00C4\u0083\u0081|\u00C4\u0082\u0081/g, "\u00C1")
    .replace(/\u00C3\u0089|\u00C4\u0083\u0089|\u00C4\u0082\u0089/g, "\u00C9")
    .replace(/\u00C3\u008D|\u00C4\u0083\u008D|\u00C4\u0082\u008D/g, "\u00CD")
...
async function loadProducts() {
  try {
    const res = await fetch(`../api/products.php?category=${encodeURIComponent(API_CATEGORY)}&limit=200`);
...
function render() {
  ...
  slice.forEach(p => {
    const detailUrl = `hangszer.html?cat=${DETAIL_CAT}&id=${p.id}&name=${encodeURIComponent(p.nev)}`;
