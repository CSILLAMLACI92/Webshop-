...
const API_CATEGORY = "basszus-gitar";
const DETAIL_CAT = "basszus";
const CATEGORY_LABEL = "Basszus gitar";
const CATEGORY_PAGE_SIZE = 6;

const NAME_POOL = ["Ibanez GSR200","Yamaha TRBX174","Fender Precision Bass","Jackson JS3 Spectra","Harley Benton JB-75","Squier Jazz Bass","Cort Action Bass","Sterling SUB Ray4","Schecter Stiletto","Epiphone Thunderbird"];
