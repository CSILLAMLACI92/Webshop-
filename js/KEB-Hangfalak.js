...
const API_CATEGORY = "hangfalak";
const DETAIL_CAT = "hangfal";
const CATEGORY_LABEL = "Hangfal";
const CATEGORY_PAGE_SIZE = 6;

const NAME_POOL = ["Yamaha HS5","KRK Rokit 5 G4","JBL 305P MKII","Behringer B112D","Mackie CR4-X","Sony Bluetooth Hangfal","Marshall Emberton II","Bose SoundLink Flex","Presonus Eris E3.5","Pioneer DJ DM-40"];
