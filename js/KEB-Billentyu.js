...
const API_CATEGORY = "billentyu";
const DETAIL_CAT = "billentyu";
const CATEGORY_LABEL = "Billentyu";
const CATEGORY_PAGE_SIZE = 6;

const NAME_POOL = ["Yamaha PSR-E373","Casio CT-X700","Roland GO:Keys","Korg B2","Yamaha P-45","Kawai ES110","Alesis Recital Pro","Kurzweil KP100","Roland FP-10","Nord Electro 6D"];
