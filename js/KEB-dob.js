const BASE_PRICE = 190000;
const API_CATEGORY = "dobszettek";
const DETAIL_CAT = "dob";
const CATEGORY_LABEL = "Dobszett";
const CATEGORY_PAGE_SIZE = 6;

const NAME_POOL = ["Tama Imperialstar","Pearl Export Series","Mapex Tornado","Ludwig Breakbeats","Sonor AQX","Gretsch Catalina","Alesis Nitro Mesh","Roland TD-1DMK","Millenium MX222BX","Yamaha Rydeen"];
